...
export default function PokemonSmallCard({ pokemon }: PropTypes) {
    ...
    return <Link href={pokemon.name} className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 pl-4 min-h-36">
